...
export default function Banner() {
  return (
    <section className="px-4 sm:px-[8vw] md:px-[12vw] 2xl:px-[16vw] flex flex-col lg:flex-row items-center lg:flex-wrap gap-x-8 gap-y-4 justify-center min-h-[2.2in] lg:min-h-[1.8in] relative">
